...
SECRET_KEY = 'django-insecure-xiic%o%s$w&d94-6wezb-gy$ktlrn47e2a!_-kk7hdb4rt$@*5'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'builtins': [
                'crispy_forms.templatetags.crispy_froms_tags',
                'crispy_forms.templatetags.crispy_froms_field',
            ]
        },
    },
]
